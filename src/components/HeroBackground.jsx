  ...
  return (
    <>
      ...
      <div style={{
        ...
        height: '85vh',
        background:
          'radial-gradient(ellipse at center, rgba(139,92,246,0.28) 0%, rgba(99,102,241,0.12) 28%, rgba(0,128,70,0.04) 58%, transparent 72%)',
        filter: 'blur(90px)',
      ...
      <div style={{
        ...
        height: '80vh',
        background:
          'radial-gradient(ellipse at center, rgba(139,92,246,0.18) 0%, rgba(99,102,241,0.07) 42%, transparent 68%)',
        filter: 'blur(120px)',
        willChange: 'transform',
      ...
      <div style={{
        ...
        height: '45vh',
        background:
          'radial-gradient(ellipse at center, rgba(139,92,246,0.15) 0%, transparent 62%)',
        filter: 'blur(80px)',
        willChange: 'transform',
      ...
      <div style={{
        ...
        height: '42vh',
        background:
          'radial-gradient(ellipse at center, rgba(139,92,246,0.08) 0%, transparent 58%)',
        filter: 'blur(60px)',
