  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background:
          'linear-gradient(180deg, rgba(5,5,15,0.5) 0%, rgba(5,5,15,0.06) 45%, rgba(5,5,15,0.5) 100%), radial-gradient(ellipse 55% 65% at 50% 50%, rgba(204,243,6,0.10), transparent 70%)',
      }} />
