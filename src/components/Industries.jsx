...
function CheckIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#CCF306" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: 2 }}>
  ...
  return (
    <div
      ...
      style={{
        background: hovered
          ? 'rgba(204,243,6,0.05)'
          : featured ? 'rgba(204,243,6,0.03)' : 'rgba(26,21,38,0.05)',
        border: featured
          ? '1px solid rgba(204,243,6,0.35)'
        ...
        boxShadow: hovered
          ? '0 20px 48px rgba(0,0,0,0.35), 0 0 0 1px rgba(204,243,6,0.06)'
    ...
    >
      ...
      <div style={{
        ...
        background: hovered
          ? 'linear-gradient(135deg, rgba(204,243,6,0.18), rgba(204,243,6,0.1))'
          : 'linear-gradient(135deg, rgba(204,243,6,0.1), rgba(204,243,6,0.05))',
        border: '1px solid rgba(204,243,6,0.18)',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        marginBottom: 24, color: '#1A1526',
        transition: 'background 0.25s ease, box-shadow 0.25s ease',
        boxShadow: hovered ? '0 0 20px rgba(204,243,6,0.15)' : 'none',
      }}>
        {icon}
      </div>
      ...
      <div style={{
        height: 1,
        background: featured ? 'rgba(204,243,6,0.12)' : 'rgba(26,21,38,0.09)',
        marginBottom: 20,
      }} />
